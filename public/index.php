...
function page_form(string $flash='', array $old=[]): string{
  ...
  return <<<HTML
<!doctype html><html lang="pt-br"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Cadastro de Pacientes Odontub</title>
